...
const CONFIG = {
    ...
    ITEMS: [
        { id: 'acid',      name: 'Acid',      minPrice: 1000,  maxPrice: 4500,   space: 1 },
        { id: 'cocaine',    name: 'Cocaine',   minPrice: 15000, maxPrice: 30000,  space: 1 },
        { id: 'hashish',    name: 'Hashish',   minPrice: 480,   maxPrice: 1400,   space: 1 },
        { id: 'heroin',     name: 'Heroin',    minPrice: 5500,  maxPrice: 14000,  space: 1 },
        { id: 'ludes',      name: 'Ludes',     minPrice: 11,    maxPrice: 60,     space: 1 },
        { id: 'mda',        name: 'MDA',       minPrice: 1500,  maxPrice: 4400,   space: 1 },
        { id: 'opium',      name: 'Opium',     minPrice: 540,   maxPrice: 1250,   space: 1 },
        { id: 'pcp',        name: 'PCP',       minPrice: 1000,  maxPrice: 2500,   space: 1 },
        { id: 'peyote',     name: 'Peyote',    minPrice: 200,   maxPrice: 700,    space: 1 },
        { id: 'shrooms',    name: 'Shrooms',   minPrice: 630,   maxPrice: 1300,   space: 1 },
        { id: 'speed',      name: 'Speed',     minPrice: 90,    maxPrice: 250,    space: 1 },
        { id: 'weed',       name: 'Weed',      minPrice: 315,   maxPrice: 890,    space: 1 },
    ],
